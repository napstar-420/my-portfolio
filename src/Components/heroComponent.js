      ...
      <div className='h-screen w-full overflow-hidden relative flex' id='hero_section'>
        ...
        <div className='bg-mainBlack flex-1 px-3 py-2 flex flex-col justify-between' id='left_side'>
          ...
          <div className='flex flex-col items-center w-max z-20'>
            ...
            <div className='mb-1 mt-2 border p-2 rounded-full border-mainGreen hover:bg-mainGreen hover:text-mainBlack transition-all text-mainGreen'><FaInstagram className=''/></div>
            <div className='my-1 border p-2 rounded-full border-mainGreen hover:bg-mainGreen hover:text-mainBlack transition-all text-mainGreen'><FaPaperPlane className=''/></div>
            <div className='mt-1 mb-2 border p-2 rounded-full border-mainGreen hover:bg-mainGreen hover:text-mainBlack transition-all text-mainGreen'><FaGithub className=''/></div>
            <div className='w-[2px] h-[5vh] bg-mainGreen'></div>
          </div>
        </div>
        ...
        <div className='bg-mainGreen flex-1 px-3 py-2 flex flex-col justify-between items-end' id='right_side'>
          <nav className='flex flex-col sm:flex-row items-end z-20'>
            <a href="#" className='text-md font-semibold text-mainBlack font-poppins sm:mx-1 lg:mx-2 cursor-pointer relative before:content-[""] before:absolute before:left-0 before:-bottom-1 before:h-1 before:bg-mainBlack before:w-0 hover:before:w-full before:transition-all before:ease-out before:duration-300'>About</a>
            <a href="#" className='text-md font-semibold text-mainBlack font-poppins sm:mx-1 lg:mx-2 cursor-pointer relative before:content-[""] before:absolute before:left-0 before:-bottom-1 before:h-1 before:bg-mainBlack before:w-0 hover:before:w-full before:transition-all before:ease-out before:duration-300'>Work</a>
            <a href="#" className='text-md font-semibold text-mainBlack font-poppins sm:mx-1 lg:mx-2 cursor-pointer relative before:content-[""] before:absolute before:left-0 before:-bottom-1 before:h-1 before:bg-mainBlack before:w-0 hover:before:w-full before:transition-all before:ease-out before:duration-300'>Connect</a>
          </nav>
